...
public class FluentTest {
  ...
  public void testApp() throws Exception {
    ...
    try {
      ...
      Collection<Map<String, Term>> answers;
      ...
      answers = jatalog.query(Expr.expr("parent", "aa", "A"), Expr.expr("parent", "aa", "B"),
          Expr.ne("A", "B"));
      assertTrue(TestUtils.answerContains(answers, "A", "aab", "B", "aaa"));
      assertTrue(TestUtils.answerContains(answers, "A", "aaa", "B", "aab"));
  ...
  public void testBindings() throws Exception {
    ...
    try {
      ...
      Map<String, Term> bindings = Jatalog.makeBindings("A", "aaa", "X", "xxx");
  ...
  public void testExecute() throws Exception {
    ...
    try {
      ...
      // Run a query:
      Collection<Map<String, Term>> answers = jatalog.executeAll("foo(What)?");
      assertTrue(answers != null);
